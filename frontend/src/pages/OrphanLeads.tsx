...
/**
 * /leads/orphans — свободный пул для менеджера.
 *
 * До 2026-09-02 здесь было 3 чипа (Свободные / Требуют пересмотра /
 * Зависли на уволенных). Два последних пула массово ушли в system-lost
 * (см. backend `mark_stranded_as_system_lost`) — их страница живёт
 * теперь под `/leads/system-lost` (superadmin only).
 *
 * Здесь остался единственный чип «Свободные» + фильтры + bulk-reassign.
 */
